...
public class EmployeeFileHandler {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(FILE_PATH))) {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (rowData.length < 19) continue; // Ensure all required fields exist before parsing.
            ...
            try {
                ...
                // Ensure SSS, PHILHEALTH, TIN, and PAGIBIG are Strings
                ...
                employees.add(new Employee(employeeNumber, lastName, firstName, phoneNumber, status, position, supervisor, address,
                    sssNumber, philHealthNumber, tinNumber, pagIbigNumber, basicSalary, riceSubsidy, phoneAllowance, clothingAllowance,
     ...
     * Modifies fields only if explicitly changed.
     *
    ...
    private static void writeEmployeeListToFile(List<Employee> employees) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH))) {
            writer.write("EmpNum,LastName,FirstName,PhoneNumber,Status,Position,Supervisor,Address,SSS,PHILHEALTH,TIN,PAGIBIG,Basic Salary,Rice Subsidy,Phone Allowance,Clothing Allowance,Gross Semi-monthly Rate,Hourly Rate,Withholding Tax\n");
    ...
    return String.join(",",
        ...
        employee.getAddress(), 
        String.valueOf(employee.getSssNumber()), String.valueOf(employee.getPhilHealthNumber()), 
        String.valueOf(employee.getTinNumber()), String.valueOf(employee.getPagIbigNumber()), 
        ...
        String.valueOf(employee.getWithholdingTax()));
}
